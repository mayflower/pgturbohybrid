...
-- ----------------------------------------------------------------------------
CREATE TABLE x4s_docs1536 (id int PRIMARY KEY, embedding vector(1536));
INSERT INTO x4s_docs1536(id, embedding)
SELECT i,
...
CREATE TABLE x4s_docs3072 (id int PRIMARY KEY, embedding vector(3072));
INSERT INTO x4s_docs3072(id, embedding)
SELECT i,
