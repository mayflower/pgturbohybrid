-- Maintainer-owned placeholder for the TurboHybrid feature review.
-- This file intentionally does not claim the next pgvector release version.
-- Upstream maintainers should rename or replace this path when assigning the
-- release version for these SQL objects.

-- complain if script is sourced in psql, rather than via CREATE EXTENSION
\echo Use "ALTER EXTENSION vector UPDATE TO '0.8.2-turbohybrid'" to load this file. \quit
