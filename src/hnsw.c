...
bool		hnsw_tq_graph_prefetch = true;
bool		hnsw_tq_graph_stack_scratch = true;
bool		hnsw_tq_graph_lowbit_popcnt = true;
bool		hnsw_tq_graph_i8mm = false;
bool		hnsw_tq_graph_avxvnni = true;
bool		hnsw_tq_graph_avx512vnni = true;
bool		hnsw_tq_graph_avx512vpopcntdq = true;
bool		hnsw_tq_weighted = false;
bool		hnsw_tq_renorm = false;
bool		hnsw_tq_query_1bit_asymmetric = false;
int			hnsw_tq_query_1bit_asymmetric_bits = 8;
bool		hnsw_tq_build_exact_distances = false;
bool		hnsw_tq_hadamard_simd = true;
bool		hnsw_tq_exact_avx512 = false;
int			hnsw_tq_simd_force = TQ_SIMD_FORCE_AUTO;
int			hnsw_tq_exact_simd_force = TQ_EXACT_SIMD_FORCE_AUTO;
int			hnsw_tq_graph_batch_scoring = TQ_GRAPH_BATCH_AUTO;
int			hnsw_tq_graph_batch_size = 4;
int			hnsw_tq_graph_avx512_weighted = TQ_GRAPH_AVX512_WEIGHTED_OFF;
int			hnsw_tq_graph_lookahead_prefetch = TQ_GRAPH_LOOKAHEAD_AUTO;
int			hnsw_tq_graph_lookahead_threshold_kb = 24576;
int			hnsw_tq_dense_budget_policy = TQ_DENSE_BUDGET_AUTO;
int			hnsw_tq_dense_max_candidate_multiplier = 4;
double		hnsw_tq_dense_latency_multiplier = 1.5;
int			hnsw_tq_dense_max_rescore_multiplier = 2;
int			hnsw_tq_rescore_band_policy = TQ_RESCORE_BAND_POLICY_AUTO;
