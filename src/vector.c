 ...
 *
 * These kernels are runtime-gated by a private exact-AVX-512 policy.
 * The path stays disabled by default until a host profiles cleanly.
 * They produce results that differ from the
