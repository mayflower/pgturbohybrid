...
#define TQ_DEFAULT_INDEX_BITS 4
#define TQ_DEFAULT_EXACT_STORAGE false
...
typedef struct HnswTqQuery
{
	 ...
	 * the private asymmetric-query path is enabled and tq_bits = 1.
	 */
	uint8	   *queryPlanes;
...
void		HnswPrepareTqQueryWithBits(Relation index, HnswSupport * support, Datum value, HnswTqQuery * tq, int tqBits);
