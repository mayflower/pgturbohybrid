...
if defined UniversalCRTSdkDir if defined UCRTVersion if exist "%UniversalCRTSdkDir%Include\%UCRTVersion%ucrt\crtdefs.h" set "UCRT_INCLUDE=%UniversalCRTSdkDir%Include\%UCRTVersion%ucrt"
if defined UniversalCRTSdkDir if defined UCRTVersion if exist "%UniversalCRTSdkDir%Include\%UCRTVersion%shared\winapifamily.h" set "SDK_SHARED_INCLUDE=%UniversalCRTSdkDir%Include\%UCRTVersion%shared"
if defined UniversalCRTSdkDir if defined UCRTVersion if exist "%UniversalCRTSdkDir%Include\%UCRTVersion%um\windows.h" set "SDK_UM_INCLUDE=%UniversalCRTSdkDir%Include\%UCRTVersion%um"
if defined UniversalCRTSdkDir if defined UCRTVersion if exist "%UniversalCRTSdkDir%Lib\%UCRTVersion%ucrt\x64\ucrt.lib" set "UCRT_LIB=%UniversalCRTSdkDir%Lib\%UCRTVersion%ucrt\x64"
if defined UniversalCRTSdkDir if defined UCRTVersion if exist "%UniversalCRTSdkDir%Lib\%UCRTVersion%um\x64\kernel32.lib" set "SDK_UM_LIB=%UniversalCRTSdkDir%Lib\%UCRTVersion%um\x64"
