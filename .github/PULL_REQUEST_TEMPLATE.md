...
Describe the change and why it belongs in `pgturbohybrid`.
...
- [ ] `REINDEX` requirement considered and documented if needed

## Notes

Include any release, compatibility, benchmark, or follow-up notes reviewers need.
